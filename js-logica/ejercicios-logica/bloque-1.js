...
export const countString = (string = "") =>
...
export const scissorString = (word = "", num = undefined) =>
    (!word)
...
export const arrayString = (word = "", space = undefined) =>
    (!word)
...
export const sentenceRepeat = (text = "", repeat = undefined) => {
